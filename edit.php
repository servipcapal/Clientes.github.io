		...
		<div class="content">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="codigo" value="<?php echo $row ['codigo']; ?>" class="form-control" placeholder="Documento"  required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="lugar_nacimiento" value="<?php echo $row ['lugar_nacimiento']; ?>" class="form-control" placeholder="Ciudad" >
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="telefono" value="<?php echo $row ['telefono']; ?>" class="form-control" placeholder="Teléfono" >
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="estado" class="form-control">
                            ...
                            <option value="1" <?php if ($row ['estado']==1){echo "selected";} ?>>Cortesía</option>
							<option value="2" <?php if ($row ['estado']==2){echo "selected";} ?>>Lanzamiento</option>
							<option value="3" <?php if ($row ['estado']==3){echo "selected";} ?>>Preventa</option>
							<option value="4" <?php if ($row ['estado']==4){echo "selected";} ?>>Pago en Taquilla</option>
							<option value="5" <?php if ($row ['estado']==5){echo "selected";} ?>>Nequi</option>
							<option value="6" <?php if ($row ['estado']==6){echo "selected";} ?>>Transferencia</option>
							<option value="7" <?php if ($row ['estado']==7){echo "selected";} ?>>Activo</option>
							<option value="8" <?php if ($row ['estado']==8){echo "selected";} ?>>Inactivo</option>
